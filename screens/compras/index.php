			...
			<article class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
				...
				if (mysqli_num_rows($result_query) > 0) {
					while ($row = mysqli_fetch_assoc($result_query)) {
						...
						<a href='desc-product.php?id=".$row['id_prod']."&pagina=1'>
								...
								<div class='p-3'>
									...
									<p class='flex items-center justify-between mt-1 text-lg font-medium text-gray-900'>R$ " . number_format($row['preco_custo_prod'], 2, ",", ".") . "" . $_SESSION['status_estoq'] . "</p>
